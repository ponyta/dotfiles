# Generated by Powerlevel10k configuration wizard on 2026-03-28 at 19:49 PDT.
...
() {
  ...
  function prompt_jj() {
    ...
    p10k segment -b 4 -f 0 -i '󰊢' -t "${info}"
  }

  function instant_prompt_jj() {
    # Show nothing in instant prompt — jj is fast enough async
  }
